...
const LandingPageView: React.FC<Props> = ({ onNavigate }) => {
  ...
  const fighters = [
    ...
    { name: '김구', desc: '임시정부 주석 / Chairman of the Provisional Government', img: 'https://amaranth-legal-sole-30.mypinata.cloud/ipfs/bafkreie4kz6obq6hjvwtrn5hi33yptemfch6kkjmwj5h22b7imipxjxd6u' },
    { name: '안중근', desc: '하얼빈 의거 / Harbin Patriotic Act', img: 'https://amaranth-legal-sole-30.mypinata.cloud/ipfs/bafkreic4bp2ylmmamglszxxnnbipbqlz535qfrhtlm5sgc72lpssvsi3x4' },
  ];
        ...
        <div className="relative z-10 text-center px-6 max-w-5xl space-y-10">
          ...
          <div className="flex justify-center">
            <h2 className="typing-effect text-lg md:text-2xl text-[#00ffcc] font-bold uppercase tracking-widest">
              Tezos FA2 Asset. 최종 머지 완료. 완벽하게 통제되는 온체인 시스템. <br/>
              <span className="text-sm opacity-80">Final Merge Complete. Fully Controlled On-chain System.</span>
            </h2>
          </div>
          ...
          <div className="stats-container flex flex-wrap items-center justify-center gap-4 md:gap-8 text-[#00ffcc] font-black text-sm md:text-lg uppercase tracking-widest pt-4">
           ...
           <div className="flex flex-col sm:flex-row items-center justify-center gap-6 pt-6">
            ...
            >
              유동성 공급 / Add Liquidity <Zap size={24} className="group-hover:fill-current" />
            </a>
            <a 
              href={walletTxUrl}
              target="_blank"
            ...
            >
              <History size={24} /> 트랜잭션 확인 / TX History
            </a>
          </div>
          ...
          <div className="bg-slate-900/40 border border-slate-800 rounded-[3rem] p-8 space-y-6 hover:border-blue-500/30 transition-all group">
            ...
            <div className="space-y-4">
              ...
              <p className="text-slate-400 text-sm font-medium leading-relaxed">
                대한민국 제21대 이재명 대통령의 디지털 유산 컬렉션. 역사적 순간들을 테조스 블록체인에서 영구히 보존합니다. <br/>
                <span className="text-xs opacity-70">Digital heritage of the 21st President Lee Jae-myeong. Preserving historical moments on Tezos.</span>
              </p>
              <a 
